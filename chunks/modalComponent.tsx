...
export default function ModalComponent({isOpened, closeFunction, children}:typeOfProps):JSX.Element {
    // Returning JSX
    return (
        <div data-opened={isOpened} className={'fixed top-0 left-0 min-h-[100vh] bg-themeColor/80 backdrop-blur w-full h-full z-20 overflow-auto transition-all duration-300 data-[opened="true"]:opacity-100 data-[opened="true"]:visible data-[opened="false"]:opacity-0 data-[opened="false"]:invisible'}>
