...
export default function DropdownComponent({children}:propsTypes):JSX.Element {
    ...
    return (
        <div className={'relative'}>
            <button className={'btn-animation dark:text-white text-black'} onClick={() => setOpened((prevState) => !prevState)}>
                <svg aria-label="More" color="currentColor" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24">
