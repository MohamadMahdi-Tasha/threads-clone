...
// Exporting info bottom component as default
        ...
        <div className={'flex lg:flex-row flex-col lg:items-center items-start justify-between gap-3'}>
            ...
            <div className={'flex items-center gap-3'}>
                <a href={`https://www.instagram.com/${id}`}>
                    <button tabIndex={-1} className={'btn-animation'}>
                        <svg aria-label="Instagram" className="x1lliihq x1n2onr6" color="rgb(243, 245, 247)" fill="rgb(243, 245, 247)" height="24" role="img" viewBox="0 0 24 24" width="24">
