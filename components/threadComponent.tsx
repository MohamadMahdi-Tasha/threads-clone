        ...
        return (
            <div>
                <Link href={`/${id}`} className={'flex lg:flex-row flex-col lg:items-center items-start gap-3 lg:w-auto w-full'}>
                    ...
                    <div>
                        <span className={'dark:text-white text-black truncate mb-3 block font-bold'}>{id}</span>
                        <p className={'dark:text-white text-black'}>{content}</p>
                    </div>
                </Link>
                ...
                <div className={'flex items-start flex-wrap gap-5 lg:ml-[50px]'}>
                    <button onClick={() => setModalOpened(true)} className={'lg:aspect-square dark:text-white text-black p-[10px] flex items-center justify-center rounded-full btn-animation dark:hover:bg-barcelonaMediaOutline hover:bg-black/20'}>
                        <svg aria-label="Like" color="currentColor" fill="transparent" height="19" role="img" viewBox="0 0 24 22" width="20"><title>Like</title>
                    ...
                    <button onClick={() => setModalOpened(true)} className={'lg:aspect-square dark:text-white text-black p-[10px] flex items-center justify-center rounded-full btn-animation dark:hover:bg-barcelonaMediaOutline hover:bg-black/20'}>
                        <svg aria-label="Comment" color="currentColor" fill="currentColor" height="20" role="img" viewBox="0 0 24 24" width="20">
                    ...
                    <button onClick={() => setModalOpened(true)} className={'lg:aspect-square dark:text-white text-black p-[10px] flex items-center justify-center rounded-full btn-animation dark:hover:bg-barcelonaMediaOutline hover:bg-black/20'}>
                        <svg aria-label="Share" color="currentColor" fill="currentColor" height="20" role="img" viewBox="0 0 24 24" width="20">
                ...
                <div className={'justify-between lg:flex block gap-5'}>
                    <div className={'lg:flex block gap-5'}>
                        <div className={'lg:flex block items-center justify-center flex-col gap-3'}>
                            ...
                            <div className={'w-[2px] lg:block hidden h-[50px] rounded-xl dark:bg-barcelonaMediaOutline bg-black/20'}></div>
                            <div className={'flex'}>
                                {
