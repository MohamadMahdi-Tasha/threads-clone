...
export default function ThreadComponent():JSX.Element {
    ...
    return (
        <div>
            <div>
                <div>
                    <img src="https://picsum.photos/100/100" alt="sylie.jahed" width="20px"/>
                    <div>
                        <span>sylie.jahad</span>
                        <p>ايد باورتون نشه ولي الآن بزرگترين چالش و التهاب زندگي من، سالم خواريه از طرف خودم نه ها اطرافيانم😕</p>
                    </div>
                </div>
                <div>
                    <span>18h</span>
