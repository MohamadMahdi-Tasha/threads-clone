    ...
    return (
        <div>
            ...
            <div className={'flex gap-5 ml-[50px]'}>
                <button onClick={() => setModalOpened(true)} className={'aspect-square p-[10px] flex items-center justify-center rounded-full btn-animation hover:bg-barcelonaMediaOutline'}>
